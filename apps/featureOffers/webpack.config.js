  ...
  return {
    ...
    plugins: [
      new ModuleFederationPlugin({
        ...
        filename: "remote.js",
        exposes: {
          "./Offers": path.join(__dirname, "./src/App"),
        },
        remotes: {
          // Utilities
        ...
        shared: {
          ...deps,
          react: {
            // A single major React version is expected
            singleton: true,
            // Do no bundle react, but use locally available lib for fallback
            import: "react",
            requiredVersion: deps.react,
          },
          "react-dom": {
            singleton: true,
            // Do not bundle react. We know that react is going to be available from elsewhere.
